...
public abstract class SolutionPanel<Solution_> extends JPanel implements Scrollable {
    ...
    protected static final String USAGE_EXPLANATION_PATH = "/taskassignment/swingui/exampleUsageExplanation.png";
    ...
    public Solution_ getSolution() {
        return (Solution_) solutionBusiness.getSolverInstance().getBestSolution();
    }
    ...
    public void doProblemFactChange(ProblemFactChange<Solution_> problemFactChange) {
        if (problemFactChange != null) {
            doProblemFactChange(problemFactChange,
                                false);
        }
    }
