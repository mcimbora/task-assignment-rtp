...
import taskassignment.domain.TaskOrEmployee;
import taskassignment.swingui.components.LabeledComboBoxRenderer;
    ...
    private class TaskAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (result == JOptionPane.OK_OPTION) {
                ...
                taskAssigningPanel.getSolverAndPersistenceFrame().resetScreen(false);
            }
        }
